...
public class DeleteFromCar extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (null != user_goods_ids){
			int goods_id = Integer.parseInt(request.getParameter("id"));
			user_goods_ids.remove(goods_id);
			request.getSession().setAttribute("user_goods_ids", user_goods_ids);
			request.getSession().setAttribute("msg", "已从购物车删除！");
		}else{
			request.getSession().setAttribute("msg", "购物车内没有货物！");
		}
