    ...
    <div class="container">
        ...
        <div class="row">
            <div class="span12">
              ...
              <form method="post" action="<%=path %>/servlet/Register" class="form-inline well">
                <fieldset>
                    <legend>用户注册</legend>
                      <% 
                        if (request.getAttribute("errors") != null){
                            ...
                            {
                      %>
                                <div class="label label-warning" align="center"> 
                                   <%=errors.get(i) %>      
                                </div><br>
                      <%
                            }
                      ...
                      %>
                    <div>
                        <p><label for="id_email">登录邮箱:</label> <input type="email" name="email" id="id_email" maxlength="45" required placeholder="请填写您的常用邮箱" /></p>
                        <p><label for="id_username">用户昵称:</label> <input id="id_username" type="text" name="username" minlength="2" maxlength="9" required placeholder="请填写您的用户昵称" /></p>
                        <p><label for="id_password1">登录密码:</label> <input id="id_password1" type="password" name="password1" maxlength="16" minlength="6" required placeholder="请填写您的登录密码" /></p>
